use super::{
    super::GatewayOpcode, DispatchEvent, DispatchEventWithTypeDeserializer, Event,
...
impl TryFrom<Event> for GatewayEvent {
    ...
    fn try_from(event: Event) -> Result<Self, Self::Error> {
        Ok(match event {
            ...
            Event::GatewayInvalidateSession(v) => Self::InvalidSession(v),
...
impl<'de> Visitor<'de> for GatewayEventVisitor<'_> {
        ...
        V: MapAccess<'de>,
    {
        ...
        let op = GatewayOpcode::deserialize(op_deser).ok().ok_or_else(|| {
        ...
        Ok(match op {
            ...
            GatewayOpcode::InvalidSession => {
                ...
                GatewayEvent::InvalidSession(invalidate)
            }
            ...
            GatewayOpcode::Resume => return Err(DeError::unknown_variant("Resume", VALID_OPCODES)),
...
impl Serialize for GatewayEvent {
    fn serialize<S: Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        const fn opcode(gateway_event: &GatewayEvent) -> GatewayOpcode {
            match gateway_event {
                GatewayEvent::Dispatch(_, _) => GatewayOpcode::Dispatch,
                GatewayEvent::Heartbeat(_) => GatewayOpcode::Heartbeat,
                GatewayEvent::HeartbeatAck => GatewayOpcode::HeartbeatAck,
                GatewayEvent::Hello(_) => GatewayOpcode::Hello,
                GatewayEvent::InvalidSession(_) => GatewayOpcode::InvalidSession,
                GatewayEvent::Reconnect => GatewayOpcode::Reconnect,
            }
        }
        ...
        match self {
            ...
            Self::InvalidSession(invalidate) => {
...
#[cfg(test)]
mod tests {
    use super::{DispatchEvent, GatewayEvent, GatewayEventDeserializer, GatewayOpcode};
    use crate::{
  ...
  "d": {
    ...
    fn deserialize_invalidate_session() {
        ...
        assert!(matches!(event, GatewayEvent::InvalidSession(true)));
    }
    ...
    fn serialize_dispatch() {
        ...
        let value = GatewayEvent::Dispatch(2_048, DispatchEvent::GuildRoleDelete(role_delete));
        ...
        serde_test::assert_ser_tokens(
            ...
            &[
                ...
                Token::U64(2_048),
                Token::Str("op"),
                Token::U8(GatewayOpcode::Dispatch as u8),
                Token::Str("d"),
                Token::Struct {
                    name: "RoleDelete",
                    len: 2,
    ...
    fn serialize_heartbeat() {
        serde_test::assert_ser_tokens(
            ...
            &[
                ...
                Token::None,
                Token::Str("op"),
                Token::U8(GatewayOpcode::Heartbeat as u8),
                Token::Str("d"),
                Token::U64(1024),
                Token::StructEnd,
            ],
    ...
    fn serialize_heartbeat_ack() {
        serde_test::assert_ser_tokens(
            ...
            &[
                ...
                Token::None,
                Token::Str("op"),
                Token::U8(GatewayOpcode::HeartbeatAck as u8),
                Token::Str("d"),
                Token::None,
                Token::StructEnd,
            ],
    ...
    fn serialize_hello() {
        serde_test::assert_ser_tokens(
            ...
            &[
                ...
                Token::None,
                Token::Str("op"),
                Token::U8(GatewayOpcode::Hello as u8),
                Token::Str("d"),
                Token::Struct {
                    name: "Hello",
                    len: 1,
    ...
    fn serialize_invalidate() {
        let value = GatewayEvent::InvalidSession(true);
        ...
        serde_test::assert_ser_tokens(
            ...
            &[
                ...
                Token::None,
                Token::Str("op"),
                Token::U8(GatewayOpcode::InvalidSession as u8),
                Token::Str("d"),
                Token::Bool(true),
                Token::StructEnd,
            ],
    ...
    fn serialize_reconnect() {
        serde_test::assert_ser_tokens(
            ...
            &[
                ...
                Token::None,
                Token::Str("op"),
                Token::U8(GatewayOpcode::Reconnect as u8),
                Token::Str("d"),
                Token::None,
                Token::StructEnd,
            ],
